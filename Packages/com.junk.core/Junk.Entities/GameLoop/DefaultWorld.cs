...
namespace Junk.Entities
{
    ...
    public unsafe partial class DestroyCommandBufferSystem : EntityCommandBufferSystem
    {
        /// <summary>
        ...
        protected override void OnCreate()
        {
            ...
            //this.RegisterSingleton<Singleton>(ref *m_PendingBuffers, World.Unmanaged, $"{nameof(DestroyCommandBufferSystem)} {nameof(Singleton)}");
            this.RegisterSingleton<Singleton>(ref *m_PendingBuffers, World.Unmanaged);
        }
    }
}